...
class PriceAggregationStrategy implements AggregationStrategy
{
    ...
    public function getBestDeals(FlightSchedules $flightSchedules, HotelStays $hotelStays)
    {
        ...
        $deals->uasort(
            function (Deal $oneDeal, Deal $anotherDeal) {
                return ($oneDeal->getTotalPrice() < $anotherDeal->getTotalPrice()) ? -1 : 1;
            }
        );
